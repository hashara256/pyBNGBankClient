...
class AddPaymentAuthorisationResponseLinksDto(object):
    ...
    def __init__(self, sca_o_auth=None, sca_status=None, _configuration=None):  # noqa: E501
        """AddPaymentAuthorisationResponseLinksDto - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def sca_o_auth(self):
        """Gets the sca_o_auth of this AddPaymentAuthorisationResponseLinksDto.  # noqa: E501

        A link to the OAuth2 configuration endpoint. When this link is present, one of the next steps is to redirect the PSU to the OAuth2 authorization endpoint.  Note that the creation of payment authorisation sub-resources at this ASPSP are created implicitly. Explicitly creation of such sub-resources do not have any follow-up actions.  Use scope PIS to redirect the PSU to the OAuth2 authorization endpoint for authorisation, instead.  # noqa: E501

        :return: The sca_o_auth of this AddPaymentAuthorisationResponseLinksDto.  # noqa: E501
        :rtype: HrefTypeDto
        """
    ...
    def sca_o_auth(self, sca_o_auth):
        """Sets the sca_o_auth of this AddPaymentAuthorisationResponseLinksDto.

        A link to the OAuth2 configuration endpoint. When this link is present, one of the next steps is to redirect the PSU to the OAuth2 authorization endpoint.  Note that the creation of payment authorisation sub-resources at this ASPSP are created implicitly. Explicitly creation of such sub-resources do not have any follow-up actions.  Use scope PIS to redirect the PSU to the OAuth2 authorization endpoint for authorisation, instead.  # noqa: E501

        :param sca_o_auth: The sca_o_auth of this AddPaymentAuthorisationResponseLinksDto.  # noqa: E501
        :type: HrefTypeDto
        """
    ...
    @property
    def sca_status(self):
        """Gets the sca_status of this AddPaymentAuthorisationResponseLinksDto.  # noqa: E501

        A link to retrieve status information of the SCA method for this payment authorisation.  # noqa: E501

        :return: The sca_status of this AddPaymentAuthorisationResponseLinksDto.  # noqa: E501
        :rtype: HrefTypeDto
        """
    ...
    def sca_status(self, sca_status):
        """Sets the sca_status of this AddPaymentAuthorisationResponseLinksDto.

        A link to retrieve status information of the SCA method for this payment authorisation.  # noqa: E501

        :param sca_status: The sca_status of this AddPaymentAuthorisationResponseLinksDto.  # noqa: E501
        :type: HrefTypeDto
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddPaymentAuthorisationResponseLinksDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddPaymentAuthorisationResponseLinksDto):
            return False
