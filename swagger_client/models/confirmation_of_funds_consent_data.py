...
class ConfirmationOfFundsConsentData(object):
    ...
    """
    swagger_types = {
        'account': 'ConfirmationOfFundsConsentAccount'
    }
    ...
    def __init__(self, account=None, _configuration=None):  # noqa: E501
        """ConfirmationOfFundsConsentData - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def account(self):
        """Gets the account of this ConfirmationOfFundsConsentData.  # noqa: E501


        :return: The account of this ConfirmationOfFundsConsentData.  # noqa: E501
        :rtype: ConfirmationOfFundsConsentAccount
        """
        return self._account

    @account.setter
    def account(self, account):
        """Sets the account of this ConfirmationOfFundsConsentData.


        :param account: The account of this ConfirmationOfFundsConsentData.  # noqa: E501
        :type: ConfirmationOfFundsConsentAccount
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfirmationOfFundsConsentData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfirmationOfFundsConsentData):
            return False
