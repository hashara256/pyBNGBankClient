...
class ReadAccountDetailsResponseDto(object):
    ...
    def __init__(self, account=None, _configuration=None):  # noqa: E501
        """ReadAccountDetailsResponseDto - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def account(self):
        """Gets the account of this ReadAccountDetailsResponseDto.  # noqa: E501

        Account with details.  # noqa: E501

        :return: The account of this ReadAccountDetailsResponseDto.  # noqa: E501
        :rtype: AccountDetailsDto
        """
        return self._account

    @account.setter
    def account(self, account):
        """Sets the account of this ReadAccountDetailsResponseDto.

        Account with details.  # noqa: E501

        :param account: The account of this ReadAccountDetailsResponseDto.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReadAccountDetailsResponseDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReadAccountDetailsResponseDto):
            return False
