...
class GetPaymentAuthorisationsResponseDto(object):
    ...
    def __init__(self, authorisation_ids=None, _configuration=None):  # noqa: E501
        """GetPaymentAuthorisationsResponseDto - a model defined in Swagger"""  # noqa: E501
    ...
    def authorisation_ids(self):
        """Gets the authorisation_ids of this GetPaymentAuthorisationsResponseDto.  # noqa: E501

        AuthorisationIds connected to the payment initiation.  # noqa: E501

        :return: The authorisation_ids of this GetPaymentAuthorisationsResponseDto.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def authorisation_ids(self, authorisation_ids):
        """Sets the authorisation_ids of this GetPaymentAuthorisationsResponseDto.

        AuthorisationIds connected to the payment initiation.  # noqa: E501

        :param authorisation_ids: The authorisation_ids of this GetPaymentAuthorisationsResponseDto.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetPaymentAuthorisationsResponseDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPaymentAuthorisationsResponseDto):
            return False
