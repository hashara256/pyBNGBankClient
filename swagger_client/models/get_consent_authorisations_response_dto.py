...
class GetConsentAuthorisationsResponseDto(object):
    ...
    def __init__(self, authorisation_ids=None, _configuration=None):  # noqa: E501
        """GetConsentAuthorisationsResponseDto - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._authorisation_ids = None
        self.discriminator = None

        if authorisation_ids is not None:
            self.authorisation_ids = authorisation_ids

    @property
    def authorisation_ids(self):
        """Gets the authorisation_ids of this GetConsentAuthorisationsResponseDto.  # noqa: E501

        AuthorisationIds connected to the consent initiation.  # noqa: E501

        :return: The authorisation_ids of this GetConsentAuthorisationsResponseDto.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def authorisation_ids(self, authorisation_ids):
        """Sets the authorisation_ids of this GetConsentAuthorisationsResponseDto.

        AuthorisationIds connected to the consent initiation.  # noqa: E501

        :param authorisation_ids: The authorisation_ids of this GetConsentAuthorisationsResponseDto.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetConsentAuthorisationsResponseDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetConsentAuthorisationsResponseDto):
            return False
